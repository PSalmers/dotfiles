...
(after! org
  ...
  (setq org-todo-keywords '((sequence "NEXT(n)" "WAIT(w@)" "|" "DONE(d)")
                            (type "PROJ(p)" "HOLD(h)" "IDEA(i)" "TODO(t)" "KILL(k@)" "|")))
  ...
  (setq! org-capture-templates '(("i" "inbox" entry
                                 ...
                                 ("p" "People" entry
                                  (file+headline "tasks.org" "People")
                                  "* %?")
                                 ("q" "Question" entry
                                  (file+headline "tasks.org" "Questions")
                                  "* NEXT %?")
                                 ("r" "Code Review" entry
                                  (file+headline "tasks.org" "Shipping/Delivery")
                                  "* NEXT [#B] Code Review [[%c][%?]]")
